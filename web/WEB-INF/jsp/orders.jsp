...
<style>
    .container-fluid{
        height: 650px;
        width: 90%;float: right;padding: 20px;border: 1px solid #ccc;
...
<div class="container-fluid">
    ...
    <%--    <li>
            <select>
                <option>
                    <p id="all" href="<%=request.getContextPath()%>/Order/getAll">全部订单</p>
                </option>
                <option>
                    <p  href="<%=request.getContextPath()%>/Order/getStop">已付款</p>
                </option>
                <option>
                    <p  href="<%=request.getContextPath()%>/Order/getAll">未付款</p>
                </option>
            </select>
        </li>--%>
       ...
       <%-- <li style="padding-left: 41%">
            <a class="btn btn-warning text-right" href="<%=request.getContextPath()%>/Order/toInsert">添加订单</a>
        </li>--%>
