...
<div class="container-fluid">
    <br><br>
    <form class="form-horizontal" action="<%=request.getContextPath()%>/Drug/insert" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group">
            <label  class="col-sm-1 control-label">添加图片</label>
            <div class="col-sm-6">
