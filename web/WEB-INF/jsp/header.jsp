...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="<%=request.getContextPath()%>/Drug/getAll">药店管理系统</a>
        </div>
        <div>
            <ul class="nav navbar-nav">
                <li ><a href="<%=request.getContextPath()%>/Drug/getAll">药品管理</a></li>
                <li ><a href="<%=request.getContextPath()%>/admin/order_list">供应商管理</a></li>
